...
class POCA(AbsSave, VoxelPlotting):
    ...
    def compute_dtheta_mean_per_vox(self, poca_points: Tensor, voi: Volume) -> Tensor:
        ...
        for i in range(voi.n_vox_xyz[2]):
            ...
            print("wherez", poca_where_z[:1000])
            ...
            for j in range(voi.n_vox_xyz[1]):
                ...
                print("wherey", poca_where_y[:1000])
                ...
                for k in range(voi.n_vox_xyz[0]):
                    ...
                    print("wherex", poca_where_x[:1000])
                    ...
                    print("wherepart", poca_where_part[:1000])
                    ...
                    print("wheretotal", poca_where_total)
